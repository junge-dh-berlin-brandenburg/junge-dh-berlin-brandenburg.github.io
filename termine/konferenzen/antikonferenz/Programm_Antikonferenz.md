...
<style>
.zeit{display: inline-block; white-space: nowrap;}
.waypoint{font-size: 1.5em; line-height: 150%;}
.speaker{font-style: italic;}
.talk-title{display: inline-block; margin-left: 2em; font-weight: bold;}
.callout{background-color: white; padding: 0.5em 0.8em; border-radius: 8px;}
table {overflow-x: scroll; width: 100%; @media screen and (width <= 500px) {font-size: 0.8em;}}
</style>
...
{%include download-button.html type="pdf" href="/assets/pdf/20260904-Anti-Konferenz-Poster-RC3.pdf" label="Programm"%}
...
| <span class="zeit">14:15–14:30</span> | Kaffeepause|
| <span class="zeit">14:30–15:30</span> | <span class="waypoint">Lightning Talks:</span><br>• <span class="speaker">Nadine Arndt, Berlin-Brandenburgische Akademie der Wissenschaften:</span><br><span class="talk-title">„Warum funktioniert das nicht?“ Zwischen Erwartungshaltung und notwendiger Formalisierung in digitalen Editionsprojekten</span><br>• <span class="speaker">Lukas Kagerer, Martin-Luther-Universität Halle-Wittenberg:</span><br><span class="talk-title">Queerness lost in Translation? Non-binäre Figuren in der Übersetzung: Ein digital-gestützter Übersetzungsvergleich von Martha Wells’ The Murderbot Diaries</span><br>• <span class="speaker">Malte Vogl, Max-Planck-Institut für Geoanthropologie:</span><br><span class="talk-title">Facing the two main obstacles of DH: Time and money</span><br>• <span class="speaker">Lukas Weimer, Niedersächsische Staats- und Universitätsbibliothek Göttingen:</span><br><span class="talk-title">Infrastruktur ohne Bühne? Über das Scheitern von Forschungsinfrastruktur-Beiträgen auf Forschungskonferenzen</span><br>• <span class="speaker">Tim Westphal, Berlin-Brandenburgische Akademie der Wissenschaften:</span><br><span class="talk-title">Busfaktor: 1 – Ein Sammelkartenspiel über den DH-, RSE- und RDM-Projektalltag</span>|
| <span class="zeit">15:30–15:45</span> | Kaffeepause|
...
- [Zum Call for Papers](/CfP_Anti-Konferenz_2026.html)